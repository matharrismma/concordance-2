...
(function () {
  ...
  var TOOLS = [
    ...
    { h: '/corpus.html',    n: 'The keeping',      k: 'library cards corpus browse search everything' },
    ...
    { h: '/corpus.html?section=drawers',    n: 'Card catalog',     k: 'encyclopedia card catalog easton dictionary reference drawers person place concept' },
    ...
    { h: '/corpus.html?section=manuscript',      n: 'The Codex',        k: 'manuscript compiled book document' },
    { h: '/corpus.html?section=volume',      n: 'The Works',         k: 'technical math science engineering worked sealed demonstrations depth proof derivation' },
