...
GOLDEN_API_GET = {
    ...
    "/now",
    "/identity", "/profile", "/profile/served", "/profile/community", "/route", "/bind/challenge", "/thread/digest", "/thread/recall", "/thread/lineage", "/thread/recalled", "/land", "/cards/for-the-group",
