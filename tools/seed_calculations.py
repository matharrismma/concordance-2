...
CALCS: list[tuple] = [
    ...
    # --- review pass: iconic formulas that clearly fit but were unplotted ---
    ("mass_energy", "Mass-energy equivalence", "E = m c^2", "physics", "proportion", "energy is proportional to mass — the constant is c^2"),
    ("rocket_equation", "Tsiolkovsky rocket equation", "dv = v_e ln(m0/mf)", "physics", "logarithmic", "delta-v is the log of the mass ratio — momentum conservation on a log scale"),
    ("reynolds_number", "Reynolds number", "Re = rho v L / mu", "physics", "fraction", "the dimensionless ratio of inertial to viscous forces — sets laminar vs turbulent"),
    ("mach_number", "Mach number", "M = v / a", "physics", "fraction", "speed as a fraction of the local speed of sound"),
    ("photoelectric", "Photoelectric effect", "E = h f - phi", "physics", "linear_map", "ejected-electron energy is affine in frequency — Einstein's quantum line"),
    ("schwarzschild", "Schwarzschild radius", "r_s = 2 G M / c^2", "physics", "proportion", "a black hole's horizon radius is proportional to its mass"),
    ("wien_displacement", "Wien's displacement law", "lambda_max = b / T", "physics", "proportion", "peak wavelength is inversely proportional to temperature"),
    ("drag_equation", "Drag equation", "F = 0.5 rho v^2 Cd A", "physics", "power_law", "drag rises with the square of speed"),
    ("electric_field", "Electric field of a point charge", "E = k Q / r^2", "electrical", "inverse_square", "the field (not the force) — the same sphere-thinning as gravity's field"),
...
CALC_THEORY: dict[str, str] = {
    ...
    "mass_energy": "card_theory_special_relativity",
    "rocket_equation": "card_theory_conservation_of_linear_angular_momentum",
    "reynolds_number": "card_theory_fluid_mechanics",
    "mach_number": "card_theory_fluid_mechanics",
    "photoelectric": "card_theory_quantization",
    "schwarzschild": "card_theory_general_relativity",
    "wien_displacement": "card_theory_electromagnetic_spectrum",
    "drag_equation": "card_theory_fluid_mechanics",
    "electric_field": "card_theory_maxwell_s_equations_classical_electromagnetism",
