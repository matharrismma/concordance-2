...
_DECKS: List[Dict[str, Any]] = [
    ...
    {"id": "word", "name": "The Dictionary & Thesaurus",
     "desc": "Every word: what it means, how it is said, and the words that stand with it.",
     "shelves": {"dictionary", "pronunciation"},
     "keywords": {"define", "definition", "meaning", "synonym", "antonym", "thesaurus", "word",
                  "spell", "vocabulary", "term", "means", "pronounce", "pronunciation", "syllable",
                  "phonetic"}},
    {"id": "scripture", "name": "Scripture & the Word",
     ...
     "shelves": {"codex", "patristics", "connections", "hymns", "commentary", "sermons",
                 "encyclopedia", "topical", "scripture", "doctrine"},
    ...
    {"id": "body", "name": "The Medicines & the Body",
     ...
     "shelves": {"medicine", "nutrition", "activities", "exercise_science"},
    ...
    {"id": "matter", "name": "Matter & the Atom",
     ...
     "shelves": {"nuclear_physics", "chemistry", "physics", "atomic", "periodic_table",
                 "molecular_geometry", "physical_constants"},
    ...
    {"id": "networks", "name": "Networks & Machines",
     ...
     "shelves": {"networking", "rfcs", "cryptography", "cybersecurity", "quantum_computing"},
    ...
    {"id": "nations", "name": "Money & the Nations",
     ...
     "shelves": {"economics", "finance", "labor", "law", "regulation", "real_estate"},
    ...
    {"id": "works", "name": "The Works — worked & sealed",
     ...
     "shelves": {"the-works", "mathematics", "geometry", "statistics", "probability", "number_theory",
                 "combinatorics", "linear_algebra", "information_theory", "formal_logic",
                 "operations_research", "unit_conversion", "timekeeping", "calendar_time",
                 "chess", "sports_analytics"},
     "keywords": {"proof", "worked", "sealed", "demonstration", "theorem", "math", "mathematics",
                  "engineering", "derivation", "verify", "seal", "calculate", "geometry", "equation",
                  "statistics", "probability", "logic", "combinatorics", "convert", "time", "date"}},
    {"id": "floor", "name": "The Floor of Discovery — the proven theories",
     "desc": "The Floor: the foundational theories, laws and principles every domain rests on — proven, "
             "credited, and held as the math floor beneath the whole keeping (Bellman at the base).",
     "shelves": {"theories"},
     "keywords": {"theory", "theories", "theorem", "law", "principle", "floor", "foundation",
                  "proven", "discovery", "bellman", "conservation", "invariant", "axiom", "lemma",
                  "fundamental", "framework", "first principles"}},
    ...
    {"id": "history", "name": "History — the dated events of the world",
     ...
     "shelves": {"history", "history_chronology"},
    ...
    {"id": "life", "name": "The Tree of Life — the living kinds",
     ...
     "shelves": {"taxonomy", "biology", "genetics"},
    ...
    {"id": "foreshadows", "name": "The Nations' Foreshadows — seeds of the Word, fulfilled in Christ",
     ...
     "shelves": {"foreshadows", "philosophy", "rhetoric"},
    ...
    {"id": "electronics", "name": "Electronics & Electrical Systems",
     ...
     "shelves": {"systems", "physics", "electrical"},
    ...
    {"id": "thermal", "name": "Thermal Systems",
     ...
     "shelves": {"systems", "physics", "thermodynamics"},
    ...
    {"id": "waves", "name": "Waves & Oscillation",
     ...
     "shelves": {"systems", "physics", "optics", "acoustics", "music_theory", "photography"},
    ...
    {"id": "field", "name": "The Field Library — survival & self-reliance",
     ...
     "shelves": {"survival", "practical", "fieldkit", "trades", "materials_science", "manufacturing",
    ...
    {"id": "earth-sciences", "name": "The Earth — geology, forests & the sciences",
     ...
     "shelves": {"geology", "ecology", "science", "soil_science", "hydrology", "oceanography", "meteorology"},
